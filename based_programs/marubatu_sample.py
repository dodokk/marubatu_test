...
def check_decision(coordinate_map):
    ...
    combinations_of_three = itertools.combinations(coordinate_map, 3)
    
    for combination in combinations_of_three:
        total_val = sum([int(i) for i in combination])
    ...
    while True:
        if turn_user == 0:
            ...
            if pre_user_input in coordinate_list:
                ...
                total_operations.append(pre_user_input)
                print(text)
            ...
            if pos_user_input in coordinate_list:
                ...
                total_operations.append(pos_user_input)
                print(text)
